...
$(TARGET): ui_mainwindow.h ui_calendar.h ui_listview.h $(OBJECTS)  
...
compiler_uic_make_all: ui_mainwindow.h ui_calendar.h ui_listview.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_calendar.h ui_listview.h
